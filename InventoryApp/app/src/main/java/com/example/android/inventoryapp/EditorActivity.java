...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private static final int EXISTIG_PRODUCT_LOADER = 0;
    ...
    public final String[] PRODUCT_COLS = {
            ...
            ProductEntry.COL_ITEMS_SOLD,
            ProductEntry.COL_SUPPLIER,
            ProductEntry.COL_PICTURE
    };
    ...
    private void saveProduct() {
        ...
        values.put(ProductEntry.COL_NAME, nameString);
        values.put(ProductEntry.COL_DESCRIPTION, descriptionString);
        values.put(ProductEntry.COL_QUANTITY, inventoryString);
        values.put(ProductEntry.COL_ITEMS_SOLD, salesString);
        values.put(ProductEntry.COL_PRICE, priceString);
        values.put(ProductEntry.COL_SUPPLIER, supplierString);
        values.put(ProductEntry.COL_PICTURE, mCurrentPhotoUri);
